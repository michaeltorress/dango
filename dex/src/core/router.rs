...
pub fn swap_exact_amount_out(
    ...
    let one_sub_fee_rate = Udec128::ONE.checked_sub(protocol_fee_rate)?; // @audit inconsistency with swap_in
    input.amount.checked_div_dec_ceil_assign(one_sub_fee_rate)?; // @audit why divide?
